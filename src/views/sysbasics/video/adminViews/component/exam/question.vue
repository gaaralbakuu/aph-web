        ...
        <div class="form">
          <el-form label-width="90px" size="medium">
            ...
            <el-form-item :label="$l.parentCatalog">
              <el-cascader v-model="catalogObj.form.pid" :options="publicCodeObj.catalogList" clearable :placeholder="$l.defaultRootCatalog"
            ...
            <el-form-item :label="$l.catalogDescription">
              <el-input v-model="catalogObj.form.description" type="textarea" :placeholder="$l.inputCatalogDescription"
                :rows="4"></el-input>
            </el-form-item>
          </el-form>
        </div>
        ...
        <div class="form">
          <el-form label-width="5em" size="medium">
            ...
            <el-form-item :label="$l.questionCategory">
              <el-cascader v-model="questionObj.form.question_category_id" :options="publicCodeObj.catalogList" clearable
                :placeholder="$l.defaultRootCatalog" :props="catalogObj.cascaderProps" style="width: 100%;">
              </el-cascader>
            </el-form-item>
            <el-form-item :label="$l.nameZh">
              <el-input v-model="questionObj.form.name_zh">
              </el-input>
            </el-form-item>
            <el-form-item :label="$l.nameTw">
              <el-input v-model="questionObj.form.name_tw">
              </el-input>
            </el-form-item>
            <el-form-item :label="$l.nameEn">
              <el-input v-model="questionObj.form.name_en">
              </el-input>
            </el-form-item>
            <el-row type="flex">
              <el-col :span="8">
            ...
            <div class="options">
              <div v-if="questionObj.form.question_type===0" class="text">
                <el-input type="textarea" :rows="2" :placeholder="$l.inputContent">
                </el-input>
              </div>
                ...
                <div class="option-card" v-for="(i,index) in templateObj.radio" :key="index">
                  <div class="oprate">
                    ...
                    <div style="font-size: 24px;">
                      ...
                      <i v-show="index+1 == templateObj.radio.length" style="color: #409fee;"
                        class="el-icon-circle-plus-outline" @click="addOption"></i>
                    </div>
                  </div>
                  <el-form label-width="60px" size="medium">
                    <el-row :gutter="10">
                      <el-col :span='7'>
                        <div class="input-box"><el-input v-model="i.name_zh">
                      ...
                      <el-col :span='3'>
                        <div class="input-box">
                          <el-switch v-model="i.is_correct" :active-value="true" :inactive-value="false"
                            active-color="#13ce66" inactive-color="#ccc" :active-text="$l.correctAnswer">
                          </el-switch>
                        </div>
                      </el-col>
                    </el-row>
    ...
    <div class="pageBody">
      <div class="questionFilter">
        <el-form inline label-width="60px">
          ...
          <el-form-item :label="$l.questionType">
            <el-select v-model="questionObj.query.question_type" @change="getQuestionList" clearable
              style="width: 100px;">
          ...
          <el-form-item :label="$l.statusFilter">
            <el-select v-model="questionObj.query.question_status" @change="getQuestionList" clearable
              style="width: 100px;">
              <el-option :label="$l.all" value=""></el-option>
              <el-option v-for="i in publicCodeObj.question_status" :key='i.value' :label="i.label"
                :value="i.value"></el-option>
      ...
      <div class="questionContent">
        <div class="catalogList">
            ...
            <el-row :gutter="10">
              <el-col :span="20">
                <el-input v-model="filterCatalogText" :placeholder="$l.filterCatalog">
                  <el-select v-model="catalogObj.query.is_valid" slot="prepend" :placeholder="$l.status" style="width: 6em;"
          ...
          <el-tree ref="catalogTree" node-key="id" :expand-on-click-node='false' :accordion="true"
            :default-expand-all="true" :data="catalogObj.list" :filter-node-method="filterCatalog">
        ...
        <div class="questionList">
          <div ref="tableContainer" style="height:calc(100% - 40px) ;">
            <el-table ref="examTable" :data="questionObj.list" tooltip-effect="dark" style="width: 100%"
              highlight-current-row highlight-selection-row stripe :header-cell-style="cssObj.headerRowStyle"
              :max-height="cssObj.tableMaxHeight" show-overflow-tooltip row-key="id">
              ...
              <el-table-column :label="$l.actions" fixed="right">
                <template slot-scope="scope">
                  ...
                  <el-button v-if="scope.row.is_valid=='Y'" type='text' style="color: #ff0000;"
                    @click="toggleQuestionStatus(scope.row)">{{ $l.disable }}</el-button>
                  <el-button v-else class="text-green" type='text'
                    @click="toggleQuestionStatus(scope.row)">{{ $l.enable }}</el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
          <el-pagination @size-change="handleSizeChange" @current-change="handlePageChange"
            :current-page="questionObj.query.page" :page-sizes="[5,10, 15, 30, 50,100]"
            :page-size="questionObj.query.pageSize" layout="total, sizes, prev, pager, next, jumper"
            :total="questionObj.total" style="float: right;">
          </el-pagination>
        </div>
      </div>
    </div>
    ...
    methods: {
      ...
      modifyCatalogStatus(data) {
        ...
        this.$prompt(msg, {
            ...
            this.$request(this.$api.videoServer + '/Video/VideoExam/DeleteOrRecoveryCatagoryById', {
              key: data.id,
              value: status,
            }, 'post').then(r => {
              this.$message({
