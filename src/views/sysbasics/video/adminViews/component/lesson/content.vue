          ...
          <div class="video">
            ...
            <div v-else class="video-card">
              <i class="el-icon-video-camera-solid"
                style="font-size: 50px;color: #55aaff;width: 100px;text-align: center;"></i>
          ...
          <div class="video-form">
            <el-form label-width="80px" size="medium">
              <el-form-item :label="$l.cover">
                ...
                <div v-else class="cover">
                  ...
                  <div class="cover-oprate">
                    ...
                    <i class="el-icon-refresh-left iconZoom"
                      @click="drawCoverByFile(uploadVideoObj.file,Math.random(0,1)*uploadVideoObj.duration)"></i>
              ...
              <el-row :gutter="16">
                <el-col :span="18">
                  <el-form-item :label="$l.college">
                    <el-select v-model="uploadVideoObj.college_id" :placeholder="$l.selectCollegePd"
                      style="width: 100%;">
                ...
                <el-col :span="6">
                  <el-form-item :label="$l.republic">
                    <el-switch v-model="uploadVideoObj.is_public" active-color="#13ce66" :active-value="1"
                      :inactive-value="0">
                    </el-switch>
                  </el-form-item>
                </el-col>
              ...
              <el-form-item :label="$l.introduce">
                <el-input v-model="uploadVideoObj.description" type="textarea" :placeholder="$l.introducePd"
                  :rows="4"></el-input>
              </el-form-item>
            </el-form>
            <div class="buttonBar">
              <el-button type="primary" @click="handleSubmit('uploadVideo')"
                :disabled="!flagObj.uploadAble">{{$l.uploadVideo}}</el-button>
              <el-button type="danger" @click="abortUploadVideo"
                :disabled="!flagObj.uploading">{{$l.giveup}}</el-button>
            </div>
          </div>
        </div>
      </el-drawer>
            ...
            <el-form label-width="80px" size="medium">
              <el-form-item :label="$l.cover">
                <div class="modifyCover">
                  <div class="cover">
                    <img class="auto-img" :src="$api.videoServer+'/'+ modifyVideoObj.form.oldthumbnail_path"
                      height="150px" />
                    <div class="cover-oprate">
                      <i class="el-icon-zoom-in iconZoom"
                        @click="coverPreview($api.videoServer+'/'+ modifyVideoObj.form.oldthumbnail_path)"></i>
                    </div>
                  </div>
              ...
              <el-row :gutter="16">
                <el-col :span="18">
                  <el-form-item :label="$l.college">
                    <el-select v-model="modifyVideoObj.form.college_id" :placeholder="$l.selectCollegePd"
                      style="width: 100%;">
                      <el-option v-for="i in publicCodeObj.collegeList" :key="i.id" :label="i.name_label"
                        :value="i.id"></el-option>
                    </el-select>
                ...
                <el-col :span="6">
                  <el-form-item :label="$l.republic">
                    <el-switch v-model="modifyVideoObj.form.is_public" active-color="#13ce66" :active-value="1"
                      :inactive-value="0">
                    </el-switch>
                  </el-form-item>
                </el-col>
              ...
              <el-form-item :label="$l.introduce">
                <el-input v-model="modifyVideoObj.form.description" type="textarea" :placeholder="$l.introducePd"
                  :rows="4"></el-input>
              </el-form-item>
            </el-form>
            <div class="buttonBar">
      ...
      <div class="videoList">
        <div class="video-content">
          <div class="video-item" v-for="i in videoListObj.list" :key="i.id">
            <div class="cover">
              <img class="auto-img" :src="$api.videoServer+'/'+i.thumbnail_path" height="130px"
                @click="coverPreview($api.videoServer+'/'+ i.thumbnail_path)">
            </div>
            <div class="content">
      ...
      deleteVideo(i) {
        if (this.rightCheck(i, true)) {
          this.$prompt(`《${i.title}》` + this.$l.deleteVideoConfirm, {
              ...
              this.$request(this.$api.videoServer + '/Video/VideoManage/deleteVideo', {
                id: i.id,
              }, 'post').then(r => {
                this.$message({
                  type: 'success',
      ...
      uploadVideo() {
        ...
        let customConfig = {
          onUploadProgress: function(progressEvent) {
            ...
            let uploadTime = (new Date().getTime() - that.uploadVideoObj.uploadEvent.oTime) /
              1000 //计算出上次调用该方法时到现在的时间差，单位为s
            ...
            that.$set(that.uploadVideoObj, 'uploadPercent', Math.round((progressEvent.loaded * 100) / progressEvent
              .total))
        ...
        this.$request(this.$api.videoServer + '/Video/VideoManage/uploadVideo', formData, 'post', 'noErrorDialog',
            customConfig,
            axiosController)
          .then(r => {
            if (r.httpCode == 200) {
